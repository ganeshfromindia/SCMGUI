      ...
      <div *ngIf="field.collections === 'yes'">
        <div formArrayName="ProductDetails">
          <div *ngFor="let itemrow of adresses.controls; let i=index" >
            <div [formGroupName]="i">
              <input type="text" name="prodcut" formControlName="product">
              <input type="text" name="description" formControlName="description"> 
              <input type="text" name="unit" formControlName="unit"> 
              <input type="number" name="qty" formControlName="qty"> 
              <input type="number" name="unitPrice" formControlName="unitPrice"> 
              <input type="number" name="totalPrice" formControlName="totalPrice"> 
              <input type="text" name="taxCode" formControlName="taxCode"> 
            </div>
